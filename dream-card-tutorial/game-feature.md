...
The recycle is to convert the card into $XWG according to the card’s reference price in the game, and such action is irreversible.
...
The mystery box is the primary source where cards come from in the game, including **ten lucky draws and single lucky draws \(under development\)**. Players can query all card information and draw probability in the prize pool.
